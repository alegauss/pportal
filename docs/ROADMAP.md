...
- ⏳ **PP26** (deps: PP23 ⏳, PP24 ✅) **3242 lines of crypto over OpenSSL sit between a registration and a session** — the three registration inits, which are where a PIN and the custom data reach the key schedule. → §PP26
