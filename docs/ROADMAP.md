...
- ⏳ **PP29** (deps: PP23 ✅, PP26 ✅) **regist.c 918, discovery.c 495 and discoveryservice.c 384, which decide whether a console pairs** — PP462 and PP463 landed the socket and its threads; discoveryservice.c's own loop - the search timer, the host list and the changed callback - has no managed model. → §PP29
