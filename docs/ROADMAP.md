...
- ⏳ **PP27** (deps: PP23 ✅, PP25 ✅, PP44 ✅) **takion.c is 1979 lines of C over raw sockets and timers, and the whole stream rides on it** — all four halves it named are modelled; what is left is the managed transport itself - Span and ArrayPool chosen deliberately, timed against the C on one capture. → §PP27
