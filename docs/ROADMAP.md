...
- ⏳ **PP8** (deps: PP4 ✅) **controller input is SDL wired into Qt events, and 950 lines of it decide what a button does** — the DualSense touchpad, motion and haptics; the loop, mappings, effects report and roster landed. → §PP8
