...
- ⏳ **PP35** (deps: PP24 ✅) **5512 lines of munit tests cover the modules this port rewrites, and nothing in a managed tree runs them** — the reorder queue's two cases; every other module's vectors are xUnit cases now. → §PP35
