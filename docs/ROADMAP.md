...
- ⏳ **PP27** (deps: PP23 ✅, PP25 ✅, PP44 ✅) (requires: console) **takion.c is 2002 lines of C over raw sockets and timers, and the whole stream rides on it** — the transport is written and budgeted by PP500; what is left is one timing run against the C, and recording takion's datagrams needs a live console. → §PP27
