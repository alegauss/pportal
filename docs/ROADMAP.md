...
- ⏳ **PP25** (deps: PP24 ✅) **the wire format is generated by nanopb, a C generator with no managed output** — the encode direction through nanopb, and the string and bytes fields it hands over as callbacks. → §PP25
