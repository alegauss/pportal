...
- 📋 **PP533** (deps: PP481 ✅) **session.c asks the C holepunch for all nine, and those asks are the only reason libchiaki links curl and json-c** — PP481 drives the nine rather than replacing them, so the seam exists in both directions and neither deletes holepunch.c. → §PP533
