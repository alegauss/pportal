...
- ⏳ **PP28** (deps: PP293 ✅, PP294 ✅, PP23 ✅) **session.c 1196, ctrl.c 1767 and streamconnection.c 1531, three state machines with no oracle** — the two joins left: the switch message with a timeout that is a failure, and the run that blocks for the whole session. → §PP28
