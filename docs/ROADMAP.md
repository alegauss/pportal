...
- ⏳ **PP26** (deps: PP23 ⏳, PP24 ✅) **3242 lines of crypto over OpenSSL sit between a registration and a session** — the 14KB of key tables, still read out of rpcrypt.c by the tests rather than carried, and the three registration inits. → §PP26
