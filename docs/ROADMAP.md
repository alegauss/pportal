...
- ⏳ **PP17** (deps: PP9 ✅, PP12 ✅) **the renderer tuning and colour mapping screens are 2132 lines of QML over libplacebo options** — the two screens' markup and the forty labels only the QML states, every rule behind them now tabled. → §PP17
