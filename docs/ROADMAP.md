...
- ⏳ **PP29** (deps: PP23 ✅, PP26 ✅) **regist.c 918, discovery.c 492 and discoveryservice.c 384, which decide whether a console pairs** — The broadcast, the discovery reply, the wake packet and the PIN exchange are still C. → §PP29
