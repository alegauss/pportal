...
eviction is the only loss in the path a decoder is responsible for. The managed host
presents and counts neither. The stream HUD has a `DroppedFrameCount` property and
nothing assigns it.
