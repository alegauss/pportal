...
is no document to implement against: the 25367 lines of C in lib/src are the
...
session.c is 1244 lines, ctrl.c 1763 and streamconnection.c 1524. Together they are the
