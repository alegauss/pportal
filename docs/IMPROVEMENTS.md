...
is no document to implement against: the 25072 lines of C in lib/src are the
...
session.c is 1244 lines, ctrl.c 1710 and streamconnection.c 1466. Together they are the
...
holepunch.c is 5797 lines and is the only translation unit in this tree that still needs
