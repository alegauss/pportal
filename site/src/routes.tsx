...
// https://alegauss.github.io/pportal/, so the canonical, the og:url, the sitemap and every
...
export type RouteMeta = {
  /** app path, leading slash: "/" or "/hardware" or "/features/picture" */
  path: string;
  title: string;
  description: string;
  ogTitle: string;
...
// The metadata table. One row per route, and the prerender reads it to patch each page's
// head. Adding a page is a row here AND a row in ROUTES below: the assertion at the bottom of
...
export const ROUTE_META: RouteMeta[] = [
  ...
  {
    path: "/hardware",
    title: hardware.meta.title,
    description: hardware.meta.description,
...
// The route to component map. The client (App) and the prerender (entry-server) both read
