...
// Renders the tagged run list from the content module (plain text, inline code, bold and
// italic) without any markup parsing, so the copy stays data and the twin generator has a
