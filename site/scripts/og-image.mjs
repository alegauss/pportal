// The social card. A platform that renders a link preview cannot rasterise an SVG, so an
// og:image pointing at one introduces the project as an empty rectangle. This rasterises
// public/og.svg to dist/og.png at 1200x630 on every build, so the card is regenerated
// whenever the mark or the copy on it changes.
