...
function blocks(node, out) {
  for (const child of node.childNodes) {
    ...
    if (cls.includes("row")) {
      ...
      // A link that wraps blocks is a card, not a run: the feature index is an <a> around a
      // heading and a paragraph, and collapsing it inline glues the title to the description.
